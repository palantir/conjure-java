...
public class SafetyUtilsTests {
    ...
    public void externalField() {
        FieldDefinition field = FieldDefinition.builder()
                ...
                .type(SAFE_EXTERNAL)
                .build();
        assertThat(SafetyUtils.getMaybeExternalSafety(field)).isPresent().get().isEqualTo(LogSafety.SAFE);
    }

    @Test
    public void nonExternalField() {
        FieldDefinition field = FieldDefinition.builder()
                .fieldName(FieldName.of("testField"))
                .type(Type.primitive(PrimitiveType.STRING))
                .build();
        assertThat(SafetyUtils.getMaybeExternalSafety(field)).isEmpty();
    }
    ...
    @Test
    public void nonExternalWrapper() {
        FieldDefinition field = FieldDefinition.builder()
                .fieldName(FieldName.of("testField"))
