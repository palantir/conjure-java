...
public final class TestCases {
    private static final List<ParameterizedTestCase> CASES = ImmutableList.<ParameterizedTestCase>builder()
            ...
            .add(ParameterizedTestCase.builder()
                    ...
                    .build())
            .add(ParameterizedTestCase.builder()
                    .name("exception-throwing-dialogue-interfaces")
                    .docs("Generate dialogue interfaces that throw custom remote exceptions")
                    .files(Path.of("cookie-service.yml"))
                    .files(Path.of("ete-service.yml"))
                    .files(Path.of("ete-binary.yml"))
                    .files(Path.of("example-errors.yml"))
            ...
            .add(ParameterizedTestCase.builder()
                    ...
                    .build())
            .add(ParameterizedTestCase.builder()
                    .name("redact-donotlog-objects")
                    .docs("Testing redacted toString and the dangerousToString escape hatch on beans and aliases."
                            + " Unions are exercised in separate cases.")
                    .files(Path.of("example-redact-donotlog-objects.yml"))
                    .options(Options.builder().redactToStringDoNotLog(true).build())
                    .generatorTypes(GeneratorType.OBJECT)
                    .build())
            .add(ParameterizedTestCase.builder()
                    .name("redact-donotlog-unions")
                    .docs("Testing redacted toString on non-sealed union variant wrappers.")
                    .files(Path.of("example-redact-donotlog-unions.yml"))
                    .options(Options.builder().redactToStringDoNotLog(true).build())
                    .generatorTypes(GeneratorType.OBJECT)
                    .build())
            .add(ParameterizedTestCase.builder()
                    .name("redact-donotlog-sealed-unions")
                    .docs("Testing redacted toString on sealed union variant wrappers.")
                    .files(Path.of("example-redact-donotlog-unions.yml"))
                    .options(Options.builder()
                            .redactToStringDoNotLog(true)
                            .sealedUnions(true)
                            .sealedUnionVisitors(true)
                            .build())
                    .generatorTypes(GeneratorType.OBJECT)
