...
public final class TestCases {
    private static final List<ParameterizedTestCase> CASES = ImmutableList.<ParameterizedTestCase>builder()
            ...
            //                    .name("template")
            //                    .docs("Testing compilation of example objects with the base set of options from our
            // templates.")
            ...
            //                    .docs("Validate that enabling both staged and strict staged builders is equivalent to
            // only"
            ...
            //                    .docs("Testing generation of objects with primitive collections and strict staged
            // builders.")
            ...
            //            .add(ParameterizedTestCase.builder()
            //                    .name("strict-false")
            //                    .docs("Validating extra properties on empty objects are allowed when the strict
            // objects feature"
            //                            + " flag is disabled.")
            ...
            //                    .generatorTypes(List.of(GeneratorType.DIALOGUE, GeneratorType.UNDERTOW,
            ...
            //                    .docs("Generate dialogue service objects with the exclude async interfaces flag
            // enabled.")
            //                    .files(Path.of("example-service.yml"))
            //                    .options(Options.builder()
            ...
            //                    .docs("Generate jersey service objects with binary fields, with jersey binary
            // responses enabled.")
            //                    .files(Path.of("example-binary.yml"))
            ...
            //                    .docs("Test generating objects with the external fallback types feature flag
            // enabled.")
            ...
            //                            .build())
            //                    .generatorTypes(List.of(GeneratorType.UNDERTOW, GeneratorType.DIALOGUE,
            // GeneratorType.OBJECT))
            //                    .build())
            //            .add(ParameterizedTestCase.builder()
            //                    .name("defensive-non-null-collections")
            //                    .docs("Generate objects with the defensive collections and non null collections flags
            // enabled.")
            ...
            //                    .docs("Test generating dialogue interfaces with methods which return endpoint
            // results")
            //                    .files(List.of(
