...
public record ReachabilityMetadata(@JsonProperty("reflection") ReflectionMetadata reflectionReachabilityMetadata) {

    public record ReflectionMetadata(List<ReflectionMetadataForType> reflectionMetadataForTypes) {
        @JsonValue
        public List<ReflectionMetadataForType> toJson() {
            return reflectionMetadataForTypes;
        }
    }

    public record ReflectionMetadataForType(
