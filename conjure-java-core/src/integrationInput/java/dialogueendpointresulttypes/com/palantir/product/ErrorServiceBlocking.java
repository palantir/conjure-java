...
public interface ErrorServiceBlocking {
            ...
            private final Deserializer<TestBasicErrorResponse> testBasicErrorDeserializer = _runtime.bodySerDe()
                    .deserializer(DeserializerArgs.<TestBasicErrorResponse>builder()
                            ...
                            .error(
                                    ...
                                    new TypeMarker<TestBasicErrorResponse.ConflictingCauseSafeArgErr>() {})
                            .build());
    ...
    sealed interface TestBasicErrorResponse
            permits TestBasicErrorResponse.Success,
                    ...
                    TestBasicErrorResponse.ConflictingCauseSafeArgErr {
        ...
        final class ConflictingCauseSafeArgErr extends EndpointError<ConjureErrors.ConflictingCauseSafeArgErrParameters>
                implements TestBasicErrorResponse {
            @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
            ConflictingCauseSafeArgErr(
                    @JsonProperty("errorCode") @Safe String errorCode,
                    @JsonProperty("errorInstanceId") @Safe String errorInstanceId,
                    @JsonProperty("parameters") ConjureErrors.ConflictingCauseSafeArgErrParameters parameters) {
                super(errorCode, ConjureErrors.CONFLICTING_CAUSE_SAFE_ARG_ERR.name(), errorInstanceId, parameters);
            }
        }
    }
