...
public final class ComplicatedObject {
    ...
    public static final class Builder {
        ...
        private List<String> fieldOne = ConjureCollections.newList();
        ...
        @JsonSetter(value = "fieldOne", nulls = Nulls.SKIP)
        public Builder fieldOne(@Nonnull Iterable<String> fieldOne) {
            checkNotBuilt();
            this.fieldOne = ConjureCollections.newList(Preconditions.checkNotNull(fieldOne, "fieldOne cannot be null"));
            return this;
        }

        public Builder addAllFieldOne(@Nonnull Iterable<String> fieldOne) {
            checkNotBuilt();
            ConjureCollections.addAll(this.fieldOne, Preconditions.checkNotNull(fieldOne, "fieldOne cannot be null"));
            return this;
        }
