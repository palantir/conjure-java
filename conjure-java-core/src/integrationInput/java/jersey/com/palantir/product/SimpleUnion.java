...
public final class SimpleUnion {
    ...
    static final class Deserializer extends ConjureUnionDeserializer<SimpleUnion> {
        ...
        protected SimpleUnion deserializeSelected(JsonParser parser, DeserializationContext context, String type)
            ...
            if (variantIndex < 0) {
                return new SimpleUnion(new UnknownWrapper(type, deserializeUnknown(parser, context)));
            }
            return new SimpleUnion((Base) deserializeVariant(parser, context, variantIndex));
        }
    }
}
