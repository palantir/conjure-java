...
public final class ConjureErrorsTypeMarkers {
    public static final TypeMarker<ConjureErrors.DifferentPackageErrorSerializableError>
            DIFFERENT_PACKAGE_ERROR_SERIALIZABLE_ERROR =
                    new TypeMarker<ConjureErrors.DifferentPackageErrorSerializableError>() {};

    public static final TypeMarker<ConjureErrors.DifferentPackageErrorException> DIFFERENT_PACKAGE_ERROR_EXCEPTION =
