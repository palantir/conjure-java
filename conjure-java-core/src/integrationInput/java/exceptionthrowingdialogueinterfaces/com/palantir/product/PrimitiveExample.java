...
public final class PrimitiveExample {
    ...
    private final ByteBuffer binaryVal;
    ...
    public ByteBuffer getBinaryVal() {
        return this.binaryVal.asReadOnlyBuffer();
    }
    ...
    public static final class Builder {
        ...
        public Builder binaryVal(@Nonnull ByteBuffer binaryVal) {
            checkNotBuilt();
            Preconditions.checkNotNull(binaryVal, "binaryVal cannot be null");
            this.binaryVal = ByteBuffer.allocate(binaryVal.remaining()).put(binaryVal.duplicate());
            ((Buffer) this.binaryVal).rewind();
            return this;
        }
