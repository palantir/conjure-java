...
public final class NestedCollectionExample {
    ...
    public static final class Builder {
        ...
        private List<List<String>> nestedList = ConjureCollections.newNonNullList();
        ...
        @JsonSetter(value = "nestedList", nulls = Nulls.SKIP, contentNulls = Nulls.FAIL)
        public Builder nestedList(@Nonnull Iterable<? extends List<String>> nestedList) {
            checkNotBuilt();
            this.nestedList = ConjureCollections.newNonNullList(
                    Preconditions.checkNotNull(nestedList, "nestedList cannot be null"));
            return this;
        }
        ...
        @JsonSetter(value = "nestedMap", nulls = Nulls.SKIP, contentNulls = Nulls.FAIL)
        ...
        @JsonSetter(value = "mixedCollection", nulls = Nulls.SKIP, contentNulls = Nulls.FAIL)
