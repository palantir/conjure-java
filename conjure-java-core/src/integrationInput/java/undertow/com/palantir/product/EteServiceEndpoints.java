...
public final class EteServiceEndpoints implements UndertowService {
    ...
    private static final class OptionalExternalLongQueryEndpoint implements HttpHandler, Endpoint {
        ...
        OptionalExternalLongQueryEndpoint(UndertowRuntime runtime, UndertowEteService delegate) {
            this.runtime = runtime;
            this.delegate = delegate;
            this.serializer = runtime.bodySerDe().serializer(TypeMarker.optionalOf(Long.class), this);
        }
    ...
    private static final class NotNullBodyExternalImportEndpoint implements HttpHandler, Endpoint {
        ...
        private final Deserializer<allexamples.com.palantir.product.StringAliasExample> deserializer;

        private final Serializer<allexamples.com.palantir.product.StringAliasExample> serializer;
        ...
        public void handleRequest(HttpServerExchange exchange) throws IOException {
            AuthHeader authHeader = runtime.auth().header(exchange);
            allexamples.com.palantir.product.StringAliasExample notNullBody = deserializer.deserialize(exchange);
            allexamples.com.palantir.product.StringAliasExample result =
    ...
    private static final class OptionalBodyExternalImportEndpoint implements HttpHandler, Endpoint {
        ...
        private final Deserializer<Optional<allexamples.com.palantir.product.StringAliasExample>> deserializer;

        private final Serializer<Optional<allexamples.com.palantir.product.StringAliasExample>> serializer;
        ...
        OptionalBodyExternalImportEndpoint(UndertowRuntime runtime, UndertowEteService delegate) {
            ...
            this.deserializer = runtime.bodySerDe()
                    .deserializer(
                            TypeMarker.optionalOf(allexamples.com.palantir.product.StringAliasExample.class), this);
            this.serializer = runtime.bodySerDe()
                    .serializer(TypeMarker.optionalOf(allexamples.com.palantir.product.StringAliasExample.class), this);
        }

        @Override
        public void handleRequest(HttpServerExchange exchange) throws IOException {
            AuthHeader authHeader = runtime.auth().header(exchange);
            Optional<allexamples.com.palantir.product.StringAliasExample> body = deserializer.deserialize(exchange);
            Optional<allexamples.com.palantir.product.StringAliasExample> result =
    ...
    private static final class OptionalQueryExternalImportEndpoint implements HttpHandler, Endpoint {
        ...
        public void handleRequest(HttpServerExchange exchange) throws IOException {
            AuthHeader authHeader = runtime.auth().header(exchange);
            Map<String, Deque<String>> queryParams = exchange.getQueryParameters();
            Optional<allexamples.com.palantir.product.StringAliasExample> query = runtime.plainSerDe()
                    .deserializeOptionalComplex(
                            queryParams.get("query"), allexamples.com.palantir.product.StringAliasExample::valueOf);
            Optional<allexamples.com.palantir.product.StringAliasExample> result =
    ...
    private static final class EnumListQueryEndpoint implements HttpHandler, Endpoint {
        ...
        EnumListQueryEndpoint(UndertowRuntime runtime, UndertowEteService delegate) {
            this.runtime = runtime;
            this.delegate = delegate;
            this.serializer = runtime.bodySerDe().serializer(TypeMarker.listOf(SimpleEnum.class), this);
        }
    ...
    private static final class OptionalEnumQueryEndpoint implements HttpHandler, Endpoint {
        ...
        OptionalEnumQueryEndpoint(UndertowRuntime runtime, UndertowEteService delegate) {
            this.runtime = runtime;
            this.delegate = delegate;
            this.serializer = runtime.bodySerDe().serializer(TypeMarker.optionalOf(SimpleEnum.class), this);
        }
    ...
    private static final class AliasLongEndpointEndpoint implements HttpHandler, Endpoint {
        ...
        AliasLongEndpointEndpoint(UndertowRuntime runtime, UndertowEteService delegate) {
            this.runtime = runtime;
            this.delegate = delegate;
            this.serializer = runtime.bodySerDe().serializer(TypeMarker.optionalOf(LongAlias.class), this);
        }
