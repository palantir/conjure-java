...
public final class LargeUnionExample {
    ...
    static final class Deserializer extends ConjureUnionDeserializer<LargeUnionExample> {
        ...
        Deserializer() {
            super(LargeUnionExample.class, VARIANT_TYPES);
        }

        @Override
        protected LargeUnionExample deserializeSelected(JsonParser parser, DeserializationContext context, String type)
                throws IOException {
            int variantIndex =
                    switch (type) {
                        case "u0" -> 0;
            ...
            if (variantIndex < 0) {
                return new LargeUnionExample(new UnknownWrapper(type, deserializeUnknown(parser, context)));
            }
            return new LargeUnionExample((Base) deserializeVariant(parser, context, variantIndex));
        }
    }
}
