...
@Safe
@JsonDeserialize(builder = OptionalAliasExample.DefaultBuilder.class)
...
public final class OptionalAliasExample {
    ...
    public static OptionalAliasStageBuilder builder() {
        return new DefaultBuilder();
    }

    public interface OptionalAliasStageBuilder {
        Completed_StageBuilder optionalAlias(@Nonnull OptionalAlias optionalAlias);

        Builder from(OptionalAliasExample other);
    }

    public interface Completed_StageBuilder {
        @CheckReturnValue
        OptionalAliasExample build();
    }

    public interface Builder extends OptionalAliasStageBuilder, Completed_StageBuilder {
        @Override
        Builder optionalAlias(@Nonnull OptionalAlias optionalAlias);
