...
@JsonDeserialize(builder = RiskyNames.DefaultBuilder.class)
...
public final class RiskyNames {
    ...
    public static VarStageBuilder builder() {
        return new DefaultBuilder();
    }

    public interface VarStageBuilder {
        Class_StageBuilder var(@Nonnull String var);

        Builder from(RiskyNames other);
    }

    public interface Class_StageBuilder {
        Int_StageBuilder class_(@Nonnull String class_);
    }

    public interface Int_StageBuilder {
        LenStageBuilder int_(@Nonnull String int_);
    }

    public interface LenStageBuilder {
        Completed_StageBuilder len(@Nonnull String len);
    }
    ...
    public interface Builder
            extends VarStageBuilder, Class_StageBuilder, Int_StageBuilder, LenStageBuilder, Completed_StageBuilder {
        @Override
        Builder var(@Nonnull String var);

        @Override
        Builder from(RiskyNames other);

        @Override
        Builder class_(@Nonnull String class_);

        @Override
        Builder int_(@Nonnull String int_);

        @Override
        Builder len(@Nonnull String len);
