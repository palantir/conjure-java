...
@JsonDeserialize(builder = ReservedKeyExample.DefaultBuilder.class)
...
public final class ReservedKeyExample {
    ...
    public static Package_StageBuilder builder() {
        return new DefaultBuilder();
    }

    public interface Package_StageBuilder {
        Interface_StageBuilder package_(@Nonnull String package_);

        Builder from(ReservedKeyExample other);
    }

    public interface Interface_StageBuilder {
        FieldNameWithDashesStageBuilder interface_(@Nonnull String interface_);
    }

    public interface FieldNameWithDashesStageBuilder {
        PrimitveFieldNameWithDashesStageBuilder fieldNameWithDashes(@Nonnull String fieldNameWithDashes);
    }

    public interface PrimitveFieldNameWithDashesStageBuilder {
        MemoizedHashCode_StageBuilder primitveFieldNameWithDashes(@Nonnull int primitveFieldNameWithDashes);
    }

    public interface MemoizedHashCode_StageBuilder {
        ResultStageBuilder memoizedHashCode_(@Nonnull int memoizedHashCode_);
    }

    public interface ResultStageBuilder {
        Completed_StageBuilder result(@Nonnull int result);
    }

    public interface Completed_StageBuilder {
        @CheckReturnValue
        ReservedKeyExample build();
    }

    public interface Builder
            extends Package_StageBuilder,
                    Interface_StageBuilder,
                    FieldNameWithDashesStageBuilder,
                    PrimitveFieldNameWithDashesStageBuilder,
                    MemoizedHashCode_StageBuilder,
                    ResultStageBuilder,
                    Completed_StageBuilder {
        @Override
        Builder package_(@Nonnull String package_);

        @Override
        Builder from(ReservedKeyExample other);

        @Override
        Builder interface_(@Nonnull String interface_);

        @Override
        Builder fieldNameWithDashes(@Nonnull String fieldNameWithDashes);

        @Override
        Builder primitveFieldNameWithDashes(@Nonnull int primitveFieldNameWithDashes);

        @Override
        Builder memoizedHashCode_(@Nonnull int memoizedHashCode_);

        @Override
        Builder result(@Nonnull int result);
