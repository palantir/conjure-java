...
@JsonDeserialize(builder = DoubleExample.DefaultBuilder.class)
...
public final class DoubleExample {
    ...
    public static DoubleValueStageBuilder builder() {
        return new DefaultBuilder();
    }

    public interface DoubleValueStageBuilder {
        Completed_StageBuilder doubleValue(@Nonnull double doubleValue);

        Builder from(DoubleExample other);
    }
    ...
    public interface Builder extends DoubleValueStageBuilder, Completed_StageBuilder {
        @Override
