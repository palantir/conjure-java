...
public final class PrimitiveOptionalsExample {
    ...
    public static AliasTwoStageBuilder builder() {
        return new DefaultBuilder();
    }

    public interface AliasTwoStageBuilder {
        AliasOptionalStageBuilder aliasTwo(@Nonnull StringAliasTwo aliasTwo);

        Builder from(PrimitiveOptionalsExample other);
    }

    public interface AliasOptionalStageBuilder {
        AliasOptionalMapStageBuilder aliasOptional(@Nonnull OptionalAlias aliasOptional);
    }

    public interface AliasOptionalMapStageBuilder {
        AliasOptionalListStageBuilder aliasOptionalMap(@Nonnull OptionalMapAliasExample aliasOptionalMap);
    }

    public interface AliasOptionalListStageBuilder {
        AliasOptionalSetStageBuilder aliasOptionalList(@Nonnull OptionalListAliasExample aliasOptionalList);
    }

    public interface AliasOptionalSetStageBuilder {
        Completed_StageBuilder aliasOptionalSet(@Nonnull OptionalSetAliasExample aliasOptionalSet);
    }

    public interface Completed_StageBuilder {
        @CheckReturnValue
        PrimitiveOptionalsExample build();

        Completed_StageBuilder num(@Nonnull OptionalDouble num);

        Completed_StageBuilder num(double num);

        Completed_StageBuilder bool(@Nonnull Optional<Boolean> bool);

        Completed_StageBuilder bool(boolean bool);

        Completed_StageBuilder integer(@Nonnull OptionalInt integer);

        Completed_StageBuilder integer(int integer);

        Completed_StageBuilder safelong(@Nonnull Optional<SafeLong> safelong);

        Completed_StageBuilder safelong(@Nonnull SafeLong safelong);

        Completed_StageBuilder rid(@Nonnull Optional<ResourceIdentifier> rid);

        Completed_StageBuilder rid(@Nonnull ResourceIdentifier rid);

        Completed_StageBuilder bearertoken(@Nonnull Optional<BearerToken> bearertoken);

        Completed_StageBuilder bearertoken(@Nonnull BearerToken bearertoken);

        Completed_StageBuilder uuid(@Nonnull Optional<UUID> uuid);

        Completed_StageBuilder uuid(@Nonnull UUID uuid);

        Completed_StageBuilder map(@Nonnull Optional<? extends Map<String, String>> map);

        Completed_StageBuilder map(@Nonnull Map<String, String> map);

        Completed_StageBuilder list(@Nonnull Optional<? extends List<String>> list);

        Completed_StageBuilder list(@Nonnull List<String> list);

        Completed_StageBuilder set(@Nonnull Optional<? extends Set<String>> set);

        Completed_StageBuilder set(@Nonnull Set<String> set);

        Completed_StageBuilder aliasOne(@Nonnull Optional<StringAliasOne> aliasOne);

        Completed_StageBuilder aliasOne(@Nonnull StringAliasOne aliasOne);

        Completed_StageBuilder aliasList(@Nonnull Optional<ListAlias> aliasList);

        Completed_StageBuilder aliasList(@Nonnull ListAlias aliasList);

        Completed_StageBuilder aliasMap(@Nonnull Optional<MapAliasExample> aliasMap);

        Completed_StageBuilder aliasMap(@Nonnull MapAliasExample aliasMap);
    }

    public interface Builder
            extends AliasTwoStageBuilder,
                    AliasOptionalStageBuilder,
                    AliasOptionalMapStageBuilder,
                    AliasOptionalListStageBuilder,
                    AliasOptionalSetStageBuilder,
                    Completed_StageBuilder {
        @Override
        Builder aliasTwo(@Nonnull StringAliasTwo aliasTwo);

        @Override
        Builder from(PrimitiveOptionalsExample other);

        @Override
        Builder aliasOptional(@Nonnull OptionalAlias aliasOptional);

        @Override
        Builder aliasOptionalMap(@Nonnull OptionalMapAliasExample aliasOptionalMap);

        @Override
        Builder aliasOptionalList(@Nonnull OptionalListAliasExample aliasOptionalList);

        @Override
        Builder aliasOptionalSet(@Nonnull OptionalSetAliasExample aliasOptionalSet);
        ...
        @Override
        Builder num(@Nonnull OptionalDouble num);

        @Override
        Builder num(double num);

        @Override
        Builder bool(@Nonnull Optional<Boolean> bool);

        @Override
        Builder bool(boolean bool);

        @Override
        Builder integer(@Nonnull OptionalInt integer);

        @Override
        Builder integer(int integer);

        @Override
        Builder safelong(@Nonnull Optional<SafeLong> safelong);

        @Override
        Builder safelong(@Nonnull SafeLong safelong);

        @Override
        Builder rid(@Nonnull Optional<ResourceIdentifier> rid);

        @Override
        Builder rid(@Nonnull ResourceIdentifier rid);

        @Override
        Builder bearertoken(@Nonnull Optional<BearerToken> bearertoken);

        @Override
        Builder bearertoken(@Nonnull BearerToken bearertoken);

        @Override
        Builder uuid(@Nonnull Optional<UUID> uuid);

        @Override
        Builder uuid(@Nonnull UUID uuid);

        @Override
        Builder map(@Nonnull Optional<? extends Map<String, String>> map);

        @Override
        Builder map(@Nonnull Map<String, String> map);

        @Override
        Builder list(@Nonnull Optional<? extends List<String>> list);

        @Override
        Builder list(@Nonnull List<String> list);

        @Override
        Builder set(@Nonnull Optional<? extends Set<String>> set);

        @Override
        Builder set(@Nonnull Set<String> set);

        @Override
        Builder aliasOne(@Nonnull Optional<StringAliasOne> aliasOne);

        @Override
        Builder aliasOne(@Nonnull StringAliasOne aliasOne);

        @Override
        Builder aliasList(@Nonnull Optional<ListAlias> aliasList);

        @Override
        Builder aliasList(@Nonnull ListAlias aliasList);

        @Override
        Builder aliasMap(@Nonnull Optional<MapAliasExample> aliasMap);
