...
@JsonDeserialize(builder = DateTimeExample.DefaultBuilder.class)
...
public final class DateTimeExample {
    ...
    public static DatetimeStageBuilder builder() {
        return new DefaultBuilder();
    }

    public interface DatetimeStageBuilder {
        Completed_StageBuilder datetime(@Nonnull OffsetDateTime datetime);

        Builder from(DateTimeExample other);
    }

    public interface Completed_StageBuilder {
        @CheckReturnValue
        DateTimeExample build();
    }

    public interface Builder extends DatetimeStageBuilder, Completed_StageBuilder {
        @Override
        Builder datetime(@Nonnull OffsetDateTime datetime);
