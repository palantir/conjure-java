...
public final class ExampleDefensiveCollectionListsUnion {
    ...
    private static final class ListWrapper implements Base {
        ...
        private ListWrapper(@JsonSetter(value = "list", nulls = Nulls.AS_EMPTY) @Nonnull List<String> value) {
            ...
            this.value = ConjureCollections.unmodifiableList(ConjureCollections.newList(value));
        }
    ...
    static final class Deserializer extends ConjureUnionDeserializer<ExampleDefensiveCollectionListsUnion> {
        private static final Class<?>[] VARIANT_TYPES =
                new Class<?>[] {ListWrapper.class, PrimitiveListWrapper.class, ListOptionalWrapper.class};

        Deserializer() {
            super(ExampleDefensiveCollectionListsUnion.class, VARIANT_TYPES);
        }

        @Override
        protected ExampleDefensiveCollectionListsUnion deserializeSelected(
            ...
            return new ExampleDefensiveCollectionListsUnion((Base) deserializeVariant(parser, context, variantIndex));
        }
    }
}
