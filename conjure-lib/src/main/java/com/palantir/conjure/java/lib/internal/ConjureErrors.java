...
public final class ConjureErrors {
    ...
    // This is used in generated code when generating errors which don't have any parameters.
    public static final EmptyErrorParameters EMPTY_ERROR_PARAMETERS_INSTANCE = new EmptyErrorParameters();

    public record EmptyErrorParameters() {}
