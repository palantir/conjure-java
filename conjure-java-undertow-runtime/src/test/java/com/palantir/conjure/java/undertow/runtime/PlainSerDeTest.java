...
public final class PlainSerDeTest {
    ...
    public void testDeserializeUuid() throws Exception {
        runDeserializerTest("Uuid", "90a8481a-2ef5-4c64-83fc-04a9b369e2b8", UUID.fromString(
    ...
    private static <T> void runDeserializerTest(
        ...
        assertThat(PlainSerDe.class.getMethod("deserialize" + typeName, String.class).invoke(PLAIN, plainIn))
                .isEqualTo(want);

        assertThatLoggableExceptionThrownBy(() -> {
                    try {
                        PlainSerDe.class.getMethod("deserialize" + typeName, String.class).invoke(
                                PLAIN, new Object[] {null});
        ...
        assertThat(PlainSerDe.class.getMethod("deserialize" + typeName, Iterable.class).invoke(
                        PLAIN, ImmutableList.of(plainIn)))
                .isEqualTo(want);
        ...
        assertThat(PlainSerDe.class.getMethod("deserializeOptional" + typeName, Iterable.class).invoke(
                        PLAIN, ImmutableList.of(plainIn)))
