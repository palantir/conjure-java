...
public interface Encoding {
     ...
     * <pre>Accept</pre>
     *
     * value is supported by this encoding. This is not an exact match on {@link #getContentType()} because values are
     * case-insensitive, see <a href="https://tools.ietf.org/html/rfc7231#section-3.1.1.1">RFC 7231</a>, and may contain
