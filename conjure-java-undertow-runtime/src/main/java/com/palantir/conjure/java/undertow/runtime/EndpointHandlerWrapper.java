 ...
 * incorrectly. Make sure to not forget passing the request to the next handlers through calling the endpoint's
 * {@link HttpHandler#handleRequest(HttpServerExchange)}. This function is used to implement filter-like behavior: -
