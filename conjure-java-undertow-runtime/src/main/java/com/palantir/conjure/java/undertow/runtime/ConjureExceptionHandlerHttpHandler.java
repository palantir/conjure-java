 ...
 */
final class ConjureExceptionHandlerHttpHandler implements HttpHandler {

    private final HttpHandler delegate;
    private final ExceptionHandler exceptionHandler;

    ConjureExceptionHandlerHttpHandler(HttpHandler delegate, ExceptionHandler exceptionHandler) {
